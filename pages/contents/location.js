        ...
        <div className="location bg-light">
          <div className="row">
            <ul className="list-group list-group-flush">
              <li className="list-group-item">Rua São Bento, 329, Sala 111</li>
              <li className="list-group-item">Seg a Sex das 8h às 18h</li>
              <li className="list-group-item">Cel.: (11) 96850-1077</li>
            </ul>
          </div>
        </div>
      </a>
